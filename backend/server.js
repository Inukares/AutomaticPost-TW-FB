...
var T; // instatiate variable, that will be later in charge of controlling Twiter API
  ...
  (req, res, next) => {
    request.post(
      ...
      function(err, r, body) {
        ...
        oauth_Tokens.oauth_token = parsedBody.oauth_token;
        oauth_Tokens.oauth_token_secret = parsedBody.oauth_token_secret;
